...
from app.config import DRAINAGE_NODES_BASE, TRANSFORMERS_BASE
...
class TelemetryGenerator:
    ...
    def compute_frame(self, storm_intensity: int = 3, weather_data: Dict[str, Any] = None) -> Dict[str, Any]:
        weather_data = weather_data or {"precipitation_mm": 10.0, "temperature_c": 30.0}
